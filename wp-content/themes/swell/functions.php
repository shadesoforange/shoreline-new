            ...
            case 'vimeo': ?>
				...
				case 'self': ?>
					<div class="video-container" style="width: 100%; height: 100%;" >
						<video id="self<?php echo $ttrust_config['video_counter']; ?>" class="html5-video player" width="100%" height="100%" <?php if( get_theme_mod( 'swell_home_image' ) ) { ?> poster="<?php echo get_theme_mod( 'swell_home_image' ); ?>" <?php } ?> loop autoplay muted oncanplay="playSelfVideo(self<?php echo $ttrust_config['video_counter']++; ?>)">
							<!-- mp4 -->
